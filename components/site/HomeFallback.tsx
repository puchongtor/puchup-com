    ...
    <>
      ...
      <section className="bg-base">
        <div className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
          <div className="mb-10 max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-bold md:text-4xl">One Page. Full Business.</h2>
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {featuredDemos.map((demo) => (
              ...
              >
                ...
                <p className="mt-4 flex-1 text-[14px] leading-relaxed text-muted">{demo.blurb}</p>
      ...
      <section className="bg-base">
        <div className="mx-auto max-w-5xl px-5 py-20 md:px-8 md:py-28">
          <div className="mb-12 max-w-xl">
            ...
            <h2 className="mt-3 text-3xl font-bold md:text-4xl">เว็บไซต์ที่ดีไม่ควรจบแค่การให้ข้อมูล</h2>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <p className="mt-1 font-semibold">/ProjectONE/baankhaokhom</p>
      ...
      <section className="bg-navy text-base">
        <div className="mx-auto max-w-3xl px-5 py-16 text-center md:px-8 md:py-20">
          ...
          <p className="mb-8 text-[16px] text-base/70">เล่าปัญหาธุรกิจมาได้เลย ไม่ต้องเตรียมบรีฟยาว</p>
          <Link
            href="/contact/"
